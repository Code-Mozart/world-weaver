...
export class DashedLinesDrawer {
    private static readonly PATTERN_IS_NULL_MESSAGE = "Can not construct a DashedLineDrawer without a pattern (i.e. a stroke style with pattern being undefined)."
